...
export default {
  data() {
    return {
      //타이틀
      pageTitle: "Best Review",
      
      reviews: [
        {
          link: "#none",
          image: "/vue-2023/src/assets/images/main/review-01.png",
          alt: '리뷰',
          width: "width:50%",
          number: "2.5",
          ...
          prodimage: "/vue-2023/src/assets/images/main/review-thumnail.png",
          prodalt: "상품이미지",
          prodbrand:"LYNN",
          prodname: "클래식 크롭 테일러드 자켓",
          prodprice: "219,000원"
        },
        {
          link: "#none",
          ...
          width: "width:25%",
          number: "1.3",
          text: "착장했을 때 이 자켓은 사진에는 차마 담겨있지 않은 엄청난 라인을 뽐낼 수 있게 합니다.",
          prodimage: "/vue-2023/src/assets/images/main/review-thumnail.png",
          prodalt: "상품이미지",
          prodbrand:"LYNN",
          prodname: "클래식 크롭 테일러드 자켓",
...
<template>
  <section class="main-sec main-review">
      ...
      <ul>
        <li v-for="(review, index) in reviews" :key="index">
          <a :href="review.link">
            ...
            <span class="review-prod">
              <span class="thumb">
                <img :src="review.prodimage" :alt="review.prodalt">
              </span>
              <span class="prod-info">
                <span class="brand">{{ review.prodbrand }}</span>
                <span class="name">{{ review.prodname }}</span>
                <span class="price">{{ review.prodprice }}</span>
              </span>
            </span>
          </a>
        </li>
